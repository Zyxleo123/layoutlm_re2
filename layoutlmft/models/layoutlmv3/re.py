...
class REDecoder(nn.Module):
    def __init__(self, config):
        super().__init__()
        self.entity_emb = nn.Embedding(4, config.hidden_size, scale_grad_by_freq=True)
    ...
    def forward(self, hidden_states, entities, relations):
        ...
        # add negative relations and labels to relations; no significant change to entities
